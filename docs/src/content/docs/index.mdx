...
hero:
  image:
    html: <img src="/hero-architecture.svg" alt="A PromptKit agent on the left dispatches MCP tool calls to three isolated sandbox containers on the right; shields on each sandbox indicate the trust boundary." width="800" />
